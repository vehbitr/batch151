...
public class Switch02 {
    ...
    /*
    Kullanicidan aldiginiz character'in sesli harf olup olmadiğini kontrol eden kodu yaziniz.
    ...
    public static void main(String[] args) {
        ...
        switch (letter){
            ...
            case 'U':
                ...
                break;
            default:
                System.out.println(letter +  " It is not a vowel");
        }
        ...
        switch (letter3){
            ...
            case "U":
                ...
                break;
            default:
                System.out.println( letter3 + " It is not a vowel");
        }
