...
public class DateTime01 {
    ...
    public static void main(String[] args) {
        ...
        LocalDate gokhanDob = LocalDate.of(1986,11,10);
        LocalDate fatifDob = LocalDate.of(1985,2,25);

        //Bir tarihin bir tarih'ten sonra olup olmadigi nasil kontrol edilir?
        boolean r1 = gokhanDob.isAfter(fatifDob);
        System.out.println(r1);// true

        //Bir tarihin bir tarih'ten once olup olmadigi nasil kontrol edilir?
        boolean r2 = fatifDob.isBefore(gokhanDob);
        System.out.println(r2);// true

        //Bir tarihin bir tarih'ten esit olup olmadigi nasil kontrol edilir?
        boolean r3 = gokhanDob.isEqual(fatifDob);
        System.out.println(r3);// false

        //Example 1: Kullanicidan aldiginiz tarih gecmise ait ise "Gecersiz tarih girdiniz" mesaji veiriniz.
