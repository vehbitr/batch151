...
public class Loops02 {
    ...
    public static void main(String[] args) {
        ...
        //3'den 8' e kadar tum sayilari console'a yazdiran kodu yaziniz
        ...
        while (m<s.length()){
            ...
            m++;//Bu kismi unutmayin yaksa "infinite loop" olusur.Yani "sonsuz loop" olusur.
                //"sonsuz loop" lar application'in donmasina sebep olur.
        }

        System.out.println();

        //Size verilen tam sayinin rakamlari toplamini konsola yazdiran kodu yaziniz
        int r = 578;
        r = Math.abs(r);
        ...
        //Kullanicidan aldiginiz String'deki sessiz harfleri console'a yazdiran kodu yazdiriniz
        //Alabama
