...
public class E01 {
    ...
    /*
        ...
        3)"Exception" a uygun cozumler uretmede "try-catch" kullanilir.
          ...
          "try block" da islem yapilirken "Exception" olursa "catch block" devreye girer ve "catch block" icindeki kodlar calis.
        4)"try block" da islem yapilirken "Exception" olusursa "try block" icindeki Exception'dan sonraki kodlar calistirilmaz. Ornek ==> System.out.println("I am here"); calismaz.
    ...
    //1.Way: Exception'i handle etmede ilk ve igrenc yol kullanilmaz
